...
- `vercel.json` CSP allows connections only to the site, the Supabase project (https and wss) and nominatim.openstreetmap.org; `geolocation=(self)` is allowed for the pickup-area button.
